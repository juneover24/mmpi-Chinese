...
questions = [
	...
	"我想成为一名护士。",
	"我认为大多数人会为了出人头地而撒谎。",
	"I do many things that I record afternoon.（我比别人看起来更后悔。）",
	"我很少和家人吵架。",
	"我因不良行为被学校停学一次或多次。",
	"有时,我有一种强烈的冲动去做一些有害或令人震惊的事情。",
	"我喜欢参加派对和其他热闹非凡的活动。",
	"我遇到过充满可能性的问题在我一直无法对他们下定决心。",
	"我相信女性应该拥有与男性一样多的性自由。",
	"我最艰难的战斗是与我自己。",
	"我爱我父亲,或者（如果你父亲死了）我爱我父亲。",
	"我的肌肉抽搐或跳跃很少或根本没有问题。",
	"我似乎不在乎发生在我身上的事。",
	"有时候,当我身体不好时,我会很烦躁。",
	"很多时候我觉得自己好像做错了什么或做了坏事。",
	"我大部分时间都很开心。",
	"我看到了别人看不到的事物、动物或人。",
	"大多数时候我的头或鼻子似乎有一种饱胀感。",
	"有些人太专横了,以至于我想做与他们要求相反的事情,即使我知道他们是对的。",
	"有人帮我解决了。",
	"我从来没有为了刺激而做过任何危险的事情。",
	"我常常觉得头上好像有一条紧绷的带子。",
	"我有时会生气。",
	...
	"在学校里,我有时会因为行为不端而被送到校长那里。",
	"我的讲话一如既往（不快不慢,没有含糊不清或声音嘶哑）",
	"我的餐桌礼仪在家里不如在外面有客人时那么好。",
	"任何有能力并愿意努力工作的人都有很大的成功机会。",
	"我似乎和我周围的大多数人一样有能力和聪明。",
	"大多数人会使用有些不公平的手段来获取利润或优势,而不是失去它。",
	"我有很多胃病。",
	"我喜欢戏剧。",
	"我知道谁对我的大部分麻烦负责。",
	...
	"我从未沉迷于不寻常的性行为。",
	"有时我的想法比我说出来的还要快。",
	"如果我可以不付钱就去看电影,并且确保我没有被看到,我可能会这样做。",
	"我经常想知道另一个人为我做些好事可能有什么隐藏的原因。",
	"我相信我的家庭生活和我认识的大多数人一样愉快。",
	"我相信执法。",
	"批评或责骂对我的伤害非常大。",
	"我喜欢做饭。",
	"我的行为很大程度上受我周围人的行为控制。",
	"我当然有时会感到无用。",
	"当我还是个孩子的时候,我属于一群历尽千难万险都想保持忠诚的朋友。",
	"我相信来世。",
	"我想当一名军人。",
	"有时我想和某人打架。",
	...
	"别人怎么看我,我不介意。",
	"即使其他人都在做同样的事情,但在派对上表演特技让我感到不舒服。",
	"我从来没有晕倒过。",
	"我喜欢上学。",
	"我经常不得不与表现出我害羞的行为作斗争。",
	"有人想毒害我。",
	...
	"我很少头痛。",
	"我的手没有变得笨拙或笨拙。",
	"有时,当我感到尴尬时,我会大汗淋漓,这让我很烦恼。",
	"我走路时保持平衡没有困难。",
	"我脑子有问题。",
	"我没有花粉症或哮喘发作。",
	"我有过无法控制自己的动作或言语的发作,但我知道我周围发生了什么。",
	"我不喜欢我认识的每个人。",
	"我很少做白日梦。",
	"我希望我不那么害羞。",
	"我不怕处理钱。",
	...
	"我有时会八卦一点。",
	"我的听力显然和大多数人一样好。",
	"我的一些家庭成员有让我非常困扰和烦恼的习惯。",
	"有时我觉得我可以异常轻松地下定决心。",
	"我想属于几个俱乐部。",
	"我几乎没有注意到我的心跳,我很少呼吸急促。",
	"我喜欢谈论性。",
	"我喜欢去我以前从未去过的地方。",
	"我受到启发,制定了一个基于责任的生活计划,此后我一直认真遵守。",
	"我有时会阻碍那些试图做某事的人,不是因为它的数量太多,而是因为事情的原则。",
	"我很容易生气,然后很快就克服了。",
	"我一直很独立,不受家庭管束。",
	"我想了很多。",
	"有人想抢劫我。",
	"我的亲戚几乎都同情我。",
	"我有一段时间非常不安,以至于我不能长时间坐在椅子上。",
	"我对爱情感到失望。",
	"我从不担心我的外表。",
	"我经常梦到最好留给自己的东西。",
	"应该向孩子们传授有关性的所有主要知识。",
	...
	"我很少或没有痛苦。",
	"我做事的方式很容易被别人误解。",
	"有时没有任何原因,甚至当事情不对劲时,我会感到兴奋或在世界之巅。",
	"我不责怪人们试图抓住他们在这个世界上所能得到的一切。",
	"有些人试图窃取我的思想和想法。",
	"我有过空白期,我的活动被打断了,我不知道我周围发生了什么。",
	"我可以与那些做我认为错误的事情的人友好相处。",
	"我喜欢和一群互相开玩笑的人在一起。",
	"有时在选举中,我会投票给那些我知之甚少的人。",
	"我开始做事有困难。",
	"我相信我是一个被定罪的人。",
	"我在学校学得很慢。",
	"如果我是艺术家,我想画花。",
